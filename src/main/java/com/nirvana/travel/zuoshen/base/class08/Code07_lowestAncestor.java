...
public class Code07_lowestAncestor {
	...
	public static Node lowestAncestor1(Node head, Node o1, Node o2) {
		...
		//parentMap用来存储节点的父节点，用于后续查找每个节点的父节点
	...
	public static class Info {
		public Node ans;//o1,o2最初交汇点
		public boolean findO1; //此子树上是否有 O1
		public boolean findO2; //此子树上是否有 O2
